...
| `terminal_window` | Floating terminal for interactive commands (`nvim_open_term` rendering, forwards manual typing). Opens per session id; no-op in headless. Driven by `services.pty`. |
